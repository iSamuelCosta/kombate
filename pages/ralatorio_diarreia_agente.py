...
unidade_saude=st.query_params['ubs']
...
faixa_etaria_sangue = conn2.query(query_faixa_etaria_diarreia_sangue_ubs(ano_selecionando, semana_selecionando, unidade_saude), ttl=60)

plano_tratamento = conn2.query(query_plano_diarreia_ubs(ano_selecionando, semana_selecionando, unidade_saude), ttl=60)
...
procedencia = conn2.query(query_procedencia_diarreia_ubs(ano_selecionando, semana_selecionando, unidade_saude), ttl=60)
...
df_pessoas = conn2.query(query_pessoas_ubs(ano_selecionando, semana_selecionando, unidade_saude), ttl=60)
...
with col10:
    if st.button("Enviar E-mail"):
        destinatario = 'gdiasrosa1@gmail.com'
